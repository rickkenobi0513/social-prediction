...
dfmerge_2 = dfmerge[dfmerge['region_africa'] != 0]
...
region.pop()
region
incidence_1 = dfmerge_1.loc[:,['incidence_1','Year','Country','prior_war','Bmean','GBmean','global_mean','regional_mean']]
incidence_1
...
#different
final = incidence_1[['Bmean','GBmean']].copy()
